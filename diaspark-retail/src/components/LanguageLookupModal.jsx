...
const LanguageLookupModal = ({ onClose, onSelect }) => {
    ...
    <div className="modal-overlay">
      <div className="language-lookup-modal">
        ...
        <div className="language-footer">
          <button className="language-action-btn" onClick={handleSelect}>Select</button>
          <button className="language-action-btn" onClick={onClose}>Cancel</button>
        </div>
      </div>
    </div>
  );
...
export default LanguageLookupModal;
