...
function EodReportPage({ onNavigate }) {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const selectedOption = 'EOD';

  const salesOptions = ['EOD'];
  ...
  const buttons = [
    'Sales and Tender Snapshot',
    'Receipt Report',
    'Z-Out Report',
    'EOD Summary',
    'Daily EOD Statistics',
    'Daily Quarter Activity',
    'Salesperson Report',
    'TriPOS Missing Transactions'
  ];
  ...
  return (
    <div className="sales-page-container">
      ...
      <div style={{ flex: 1, backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '40px', gap: '15px' }}>
        {buttons.map(btn => (
